...
package user_level_schedulers is
   ...
   protected user_level_scheduler is
      ...
      procedure set_task_criticality (id : Integer; s : Integer);
      procedure set_task_user_priority (id : Integer; s : Integer);
      procedure decrease_remaining_capacity (id : Integer);
      procedure reset_remaining_capacity (id : Integer);
   ...
   procedure muf_schedule (duration_in_time_unit : Integer);
